...
INSERT INTO tipi_piatto (nome) VALUES
 ...
 select nome, prezzo from piatti p;
 
 select p.nome as portata, p.prezzo, categorie.nome as tipo 
 from piatti p, tipi_piatto as categorie
 where p.tipo_piatto_id = categorie.id
 and categorie.nome = 'Secondo';
 -- join tra le tabelle prendo come riferimento la chiave primaria delle categorie e la fk dei piatti
