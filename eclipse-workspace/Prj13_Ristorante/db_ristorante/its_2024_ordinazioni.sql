...
CREATE TABLE `ordinazioni` (
  ...
  `id_primo_piatto` int NOT NULL,
  `id_secondo_piatto` int NOT NULL,
...
INSERT INTO `ordinazioni` VALUES (1,1,5,9,13,15.00),(2,1,5,9,13,15.00),(3,2,6,10,14,15.00),(4,3,7,11,15,15.00),(5,4,8,12,16,15.00),(6,1,5,9,13,15.00),(7,2,6,10,14,15.00),(8,3,7,11,15,15.00),(9,4,8,12,16,15.00);
